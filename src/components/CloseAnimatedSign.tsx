...
function CloseAnimatedSign({isOpen,toggle}:IOpenHamburger) {
  return (
    <div className="lg:fixed absolute lg:top-30 top-19 z-[51] m-3" >
      ...
      >
        <span className="block bg-gray-800 dark:bg-gray-500 h-1 rounded-full  transition-all duration-300"></span>
        <span className="bg-gray-800 dark:bg-gray-500 h-1 rounded-full transition-all duration-300"></span>
        <span className="bg-gray-800 dark:bg-gray-500 h-1 rounded-full transition-all duration-300"></span>
      </div>
    </div>
  );
